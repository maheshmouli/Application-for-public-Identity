...
public class Upload2 extends HttpServlet {
  ...
  int r = Math.abs(generator.nextInt());
	...
	try {
            ...
            String type,rto,name,gender,dob,country,fname,address,qualification,marks,blood,aadhar,email;
           type=m.get(0);
           rto=m.get(1);
           name=m.get(2);
           gender=m.get(3); 
          ...
          String x="insert into license(iid,type,rto,name,gender,dob,country,fname,address,qualification,marks,blood,aadhar,email)values('"+uid+"','"+type+"','"+rto+"','"+name+"','"+gender+"','"+dob+"','"+country+"','"+fname+"','"+address+"','"+qualification+"','"+marks+"','"+blood+"','"+aadhar+"','"+email+"')"; 
          PreparedStatement ps1 = con.prepareStatement(x);
            ps1.executeUpdate();
        out.println("<script>"
				+"alert('Successfully Applied and check your mail for confirmation details')"
				+"</script>");
         RequestDispatcher rd=request.getRequestDispatcher("drive.jsp");
