...
public class Upload extends HttpServlet {
  ...
  int r = Math.abs(generator.nextInt());
	...
	try {
            ...
            String name,fname,mobile,email,dob,income,address,state,pincode,country,aadhar;
            name=m.get(0);
           fname=m.get(1);
           mobile=m.get(2);
           email=m.get(3); 
          ...
          Class.forName("com.mysql.jdbc.Driver");
            ...
            String x="insert into pan(iid,name,fname,mobile,email,dob,income,address,state,pincode,country,aadhar)values('"+uid+"','"+name+"','"+fname+"','"+mobile+"','"+email+"','"+dob+"','"+income+"','"+address+"','"+state+"','"+pincode+"','"+country+"','"+aadhar+"')";
        PreparedStatement ps1 = con.prepareStatement(x);
        ps1.executeUpdate();
        out.println("<script>"
				+"alert('Successfully Applied and check your mail for confirmation details')"
				+"</script>");
         RequestDispatcher rd=request.getRequestDispatcher("pan.jsp");
