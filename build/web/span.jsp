...
<div id="container" class="width">
		...
		<nav>
    			...
    			<ul class="sf-menu dropdown">
        			...
        			<li ><a href="adminhome.jsp"><i class="fa fa-home"></i> Home</a></li>
                                <li class="selected" ><a href="span.jsp"><i class="fa fa-briefcase"></i>Applicants for Pan card</a></li>
                                <li><a href="svoter.jsp"><i class="fa fa-briefcase"></i>Applicants for Voter Id</a></li>
    ...
    <td>&nbsp;</td>
         ...
         <tr>  
                                    ...
                                    <td align="center" style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&nbsp;&nbsp;Father Name</strong></b></td>
                                    <td align="center" style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&nbsp;&nbsp;Email</strong></b></td>
                                    <td align="center" style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&nbsp;&nbsp;DOB</strong></b></td>
                                    <td align="center" style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&nbsp;&nbsp;Income</strong></b></td>
...
<%  
                        ...
                        String q="select * from pan where status='De-Active'";
                        ...
                        String id, email;
                                ...
                                <tr>                                  
                                    ...
                                    <td align="center" style="color:#080606;font-weight: bold;">&nbsp;&nbsp;<%=rst.getString("email")%></td>
                                    <td align="center" style="color:#080606;font-weight: bold;">&nbsp;&nbsp;<%=rst.getString("dob")%></td>
                                    <td align="center" style="color:#080606;font-weight: bold;">&nbsp;&nbsp;<%=rst.getString("income")%></td>
                                    ...
                                    <td align="center" style="color:#080606;font-weight: bold;">&nbsp;&nbsp;<a href="accept1.jsp?uid=<%=rst.getString("id")%>&&email=<%=rst.getString("email")%>">Accept</a></td>
 <tr>
    <th scope="row">&nbsp;</th>
    <td>&nbsp;</td>
  </tr>
