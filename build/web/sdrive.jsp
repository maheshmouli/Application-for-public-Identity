...
<div id="container" class="width">
    ...
    <td>&nbsp;</td>
         ...
         <tr>  
                                    <td align="center" style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&nbsp;&nbsp;Type</strong></b></td>
                                    <td align="center" style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&nbsp;&nbsp;RTO</strong></b></td>
                                    ...
                                    <td align="center" style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&nbsp;&nbsp;Qualification</strong></b></td>
                                    <td align="center" style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&nbsp;&nbsp;Marks</strong></b></td>
...
<%                        
                        ...
                        String q="select * from license where status='De-Active'";
                        ...
                        while(rst.next())
                                      {
                                         ...
                                         System.out.println(id);
                                          ...
                                          %>
                                <tr>                                  
                                    <td align="center" style="color:#080606;font-weight: bold;">&nbsp;&nbsp;<%=rst.getString("type")%></td>
                                    <td align="center" style="color:#080606;font-weight: bold;">&nbsp;&nbsp;<%=rst.getString("rto")%></td>
                                    <td align="center" style="color:#080606;font-weight: bold;">&nbsp;&nbsp;<%=rst.getString("name")%></td>
                                    ...
                                    <td align="center" style="color:#080606;font-weight: bold;">&nbsp;&nbsp;<%=rst.getString("qualification")%></td>
                                    <td align="center" style="color:#080606;font-weight: bold;">&nbsp;&nbsp;<%=rst.getString("marks")%></td>
                                    <td align="center" style="color:#080606;font-weight: bold;">&nbsp;&nbsp;<%=rst.getString("aadhar")%></td>
                                    
                                    <td align="center" style="color:#080606;font-weight: bold;">&nbsp;&nbsp;<a href="accept3.jsp?uid=<%=rst.getString("id")%>&&email=<%=email%>">Accept</a></td>
 <tr>
    <th scope="row">&nbsp;</th>
    <td>&nbsp;</td>
  </tr>
