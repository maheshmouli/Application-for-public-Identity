<%-- 
    Document   : accept2
    Created on : Feb 3, 2018, 9:43:06 PM
    Author     : DLK
--%>
...
String sql="update vote set status='Active' where id='"+fid+"' and status='De-Active' ";
...
mail mm = new mail();
            String from,pass,subject,message;
             ...
             message="Your application has been accepted and soon you will get your Voter Id Card";
