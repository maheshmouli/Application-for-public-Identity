...
<div id="container" class="width">
		...
		<nav>
    			...
    			<ul class="sf-menu dropdown">
        			...
        			<li ><a href="index.jsp"><i class="fa fa-home"></i> Home</a></li>
                                <li class="selected"><a href="admin.jsp"><i class="fa fa-briefcase"></i> Admin</a></li>
    ...
    <div id="body" class="width">
	    ...
	    <article>
			...
			<h3>Login</h3>
                        <form action="Alogin">
                            UserName&emsp;<input type="text" name="u"><br><br>
                            Password&emsp;<input type="password" name="p"><br><br>
