		...
		<nav>
    			...
    			<ul class="sf-menu dropdown">
        			...
        			<li  class="selected" ><a href="adminhome.jsp"><i class="fa fa-home"></i> Home</a></li>
                                <li ><a href="span.jsp"><i class="fa fa-briefcase"></i>View applicants for Pan card</a></li>
                                <li><a href="svoter.jsp"><i class="fa fa-briefcase"></i>View applicants for Voter Id</a></li>
            			<li><a href="sdrive.jsp"><i class="fa fa-briefcase"></i>View applicants for Driving License</a></li>
